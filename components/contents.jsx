  ...
  return (
    <>
      <div className="sm:w-[76%]">
        <div id="imgContainer" className="relative sm:w-[100%]">
          <Image
            ...
            priority
            layout="responsive"
            className="sm:w-[100%] "></Image>
          <div
            id="text"
            className="absolute bottom-0 right-0 p-[10px] sm:p-[40px] text-right">
        ...
        <div
          id="textContent"
          className=" h-dvh sm:flex sm:h-[367px] bg-[#DCCCBC] sm:w-[100%]">
          <div className="flex gap-[20px] px-[20px] py-[50px] xl:p-[50px] xl:w-[100%]">
